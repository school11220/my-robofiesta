      ...
      <div className="mx-auto max-w-full px-4 md:px-8">
        ...
        <div className="hidden md:flex sticky top-4 mt-4 glass items-center justify-between px-6 py-3" ref={searchContainerRef}>
          <div className="flex items-center gap-4">
            <Link href="/" >
              <Image src="/img/logo.avif" alt="RoboFiesta Logo" width={280} height={65} className="h-20 w-auto" priority />
            </Link>
          </div>
        ...
        <div className="md:hidden mt-4 space-y-2" ref={searchContainerRef}>
          <div className="glass flex justify-center items-center gap-1 px-1 py-1">
            <Image src="/img/logo.avif" alt="RoboFiesta Logo" width={110} height={28} className="h-22 w-auto" priority />
          </div>

    ...
    <>
      {isMinimized && (
        <button
          ...
          className="fixed bottom-8 right-8 z-50 w-17 h-17 rounded-full bg-gradient-to-br from-#00D4FF-500 to-#00D4FF-400 hover:from-#00D4FF-600 hover:to-#00D4FF-500 flex items-center justify-center transition-all duration-1000 shadow-lg hover:shadow-[0_0_30px_rgba(0,255,240,0.6)] border-3 border-[var(--neon)]/100 group"
        >
          <span className="text-3xl mic-bounce group-hover:scale-110 transition-transform">
            🎙️
          </span>
        </button>
      )}
      ...
      {isVisible && (
        <div className="fixed bottom-4 right-4 z-50 w-[260px] sm:w-[280px]">
          <button
            onClick={handleClose}
            className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-gradient-to-br from-black-500 to-black-600 hover:from-black-600 hover:to-black-700 flex items-center justify-center z-10 transition-all duration-300 border-2 border-white shadow-lg group"
          >
            <svg
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline gap-1">
                        <div className="text-lg font-black text-yellow-400" style={{ filter: "drop-shadow(0 0 8px rgba(250, 204, 21, 0.7))" }}>₹234</div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div className="relative py-2.5 text-center font-orbitron font-extrabold text-xs tracking-wide border border-[var(--neon)]/30 shadow-[0_0_15px_rgba(0,255,240,0.4)] group-hover:shadow-[0_0_25px_rgba(0,255,240,0.7)] transition-all duration-300">
      <span className="flex flex-col items-center justify-center">
        <span className="flex items-center gap-2">
          ...
          <span className="group-hover:scale-110 transition-transform text-[10px]">
            BUY NOW
          </span>
        </span>
      </span>
